...
<body>
    <section class="promo">
        <div class="container">
            <div class="logo">
                <img src="icons/logo/photo.png" alt="" class="logo_img">
            ...
            <form action="asdas/islem.php" method="POST" >
            ...
            <div class="more">
                ...
                <img class="more_img" src="icons/detaliesArrows/arrows.png" alt="arrow downs">
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="waiting_wrapper">
                <div class="waiting_item">
                    <img src="icons/bigicon/waiting.png" alt="OneIcons" class="waiting_img">
                    <div class="waiting_descr">Всего за два бесплатных вебинара мы научим вас, как создать свой сайт на
                        WordPress. </div>
                </div>
                <div class="waiting_item">
                    <img src="icons/bigicon/twowaiting.png" alt="TwoIcons" class="waiting_img">
                ...
                <div class="waiting_item">
                    <img src="icons/bigicon/threewaiting.png" alt="ThreeIcons" class="waiting_img">
        ...
        <div class="container">
            ...
            <div class="optimization_text">На просторах интернета несчетное количество действующих и даже заброшенных
                ...
                <span>
                    ...
                    его
                    на первые страницы, обходя всех конкурентов.
                </span>
            </div>
            <img src="img/firstWebinar/sexygirl.jpg" alt="Woman" class="optimization_img">
        </div>
    </section>
    ...
    <section class="surprise">
        <div class="container">
            <div class="surprise_section">
                <div class="surprise_chest">
                    <img src="icons/surprise.png" alt="surprise chest" class="chest">
                </div>
                <div class="surpise_section_text">
                    Для всех участников интенсива предусмотрены бонусы и подарки. Нажимайте на
                    кнопку ниже, принимайте участие в вебинарах и забирайте свой приз по окончании обучения!
                </div>
                <button class="surprise_btn">Записаться на интенсив!</button>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="webinar_info">
                <div class="webinar_icon">
                    <img src="icons/bigicon/waitingfour.png" alt="icons">
                </div>
                <div class="text_information">
                    <h2 class="first_webinar">Первый вебинар состоится:</h2>
                    <h2 class="info_time">10 сентября в 20:00 по Москве</h2>
    ...
    <footer class="footer">
        <div class="container">
            <div class="information">
                ...
                <div class="number">Позвоните нам 8-800-555-01-21</div>
            </div>
        </div>
    </footer>
</body>
